...
struct LicenseSettingsView: View {
    ...
    private var activationForm: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack {
                ...
                Button("Buy License") {
                    if let url = URL(string: "https://github.com/anthonyjohn17/PsstWhisperOS") {
    ...
    private var statusSubtitle: String {
        switch licenseManager.licenseState {
        case .licensed:
            return "Thank you for supporting PsstWhisperOS!"
        case .trial:
            return "\(licenseManager.trialDaysRemaining) days remaining in your free trial."
        case .expired:
            return "Your trial has ended. Enter a license key to continue using PsstWhisperOS."
        case .checking:
