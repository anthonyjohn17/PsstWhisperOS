...
class HotkeyManager: ObservableObject {
    ...
    private func setupEventTap() {
        ...
        if !hasListenAccess {
            print("HotkeyManager: Input Monitoring not granted — open System Settings and enable PsstWhisperOS")
        }
        ...
        if let eventTap = eventTap {
            ...
            if !hasPromptedUser {
                ...
                if !listenAccess {
                    print("HotkeyManager: Opening Input Monitoring settings for user (missing: \(missingStr))")
