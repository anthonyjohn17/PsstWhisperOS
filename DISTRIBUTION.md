# PsstWhisperOS — Commercial Distribution Checklist
...
- [ ] Use your identity: John Anthony
...
- [ ] Store credentials for the build script:
  ```bash
  export DEVELOPER_ID="Developer ID Application: John Anthony (YOUR_TEAM_ID)"
...
- [ ] Replace `SPARKLE_ED25519_PUBLIC_KEY_PLACEHOLDER` in `Sources/PsstWhisperOS/Info.plist` with your public key
...
- [ ] Create a product for PsstWhisperOS (one-time payment, suggested $29)
...
- [ ] Register a domain or use GitHub Pages for releases and appcast hosting
...
# Upload dist/PsstWhisperOS-1.0.0.dmg + website/appcast.xml to your hosting
```

## 9. Version Bumps

For new releases, update the version in `Sources/PsstWhisperOS/Info.plist`:
